...
def expand():
    ...
    parser.add_argument('--dirpath', default='data/structure.json',help="Path for the directory")
    ...
    parser.add_argument('--filter', help="Filter by file[--filter==file] or directory[--filter==dir]") #,choices=['file', 'dir']
    parser.add_argument('-h',action='store_true',help='Print human-readable sizes')
    parser.add_argument("--help", action='help',help='Find Help')
    ...
    if current_directory is not None:
        # Linux ls commands
        files = ls(current_directory,show_hidden,use_long_format)
        # Display
        display(files,use_long_format,reverse_order,sort_by_time,filter_option,human_readable)
